...
public class NGrams extends PreprocessFilter {
	...
	public NGrams(PreprocessFilter crtfilter, int n) {
		...
		this.crtList = process(crtString, n, true);
		// String newString = crtList.toString();
		// crtfilter.setCrtString(newString);
	}

	public NGrams(PreprocessFilter crtfilter, int n, boolean withSpace) {
		this.crtString = crtfilter.getCrtString();
		this.crtList = process(crtString, n, withSpace);
		// String newString = crtList.toString();
		// crtfilter.setCrtString(newString);
	}
	...
	public NGrams(String text, int n) {
		this.crtString = text;
		this.crtList = process(this.crtString, n, true);
	}

	public NGrams(String text, int n, boolean withSpace) {
		this.crtString = text;
		this.crtList = process(this.crtString, n, withSpace);
	}
	...
	public List<String> process(String text, int n, boolean withSpace) {
