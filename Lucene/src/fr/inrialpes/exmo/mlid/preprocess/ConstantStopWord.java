...
public class ConstantStopWord {
	 ...
	 */
	private static String english_list[] = { "a", "about", "above", "after", "again",
	 ...
	 */
	private static String chinese_list[] = { "的", "一", "不", "在", "人", "有", "是", "为",
			"以", "于", "上", "他", "而", "后", "之", "来", "及", "了", "因", "下", "可",
			"到", "由", "这", "与", "也", "此", "但", "并", "个", "其", "已", "无", "小",
			"我", "们", "起", "最", "再", "今", "去", "好", "只", "又", "或", "很", "亦",
			"某", "把", "那", "你", "乃", "它", "吧", "被", "比", "别", "趁", "当", "从",
			"到", "得", "打", "凡", "儿", "尔", "该", "各", "给", "跟", "和", "何", "还",
			"即", "几", "既", "看", "据", "距", "靠", "啦", "了", "另", "么", "每", "们",
			"嘛", "拿", "哪", "那", "您", "凭", "且", "却", "让", "仍", "啥", "如", "若",
			"使", "谁", "虽", "随", "同", "所", "她", "哇", "嗡", "往", "哪", "些", "向",
			"沿", "哟", "用", "于", "咱", "则", "怎", "曾", "至", "致", "着", "诸", "自" };

	/**
	 * Liste des mots vide de la langue française
	 */
	private static String french_list[] = { "au", "aux", "avec", "ce", "ces", "dans",
			"de", "des", "du", "elle", "en", "et", "eux", "il", "je", "la",
			"le", "leur", "lui", "ma", "mais", "me", "même", "mes", "moi",
			"mon", "ne", "nos", "notre", "nous", "on", "ou", "par", "pas",
			"pour", "que", "qui", "sa", "se", "ses", "son", "sur", "ta", "te",
			"tes", "toi", "ton", "tu", "un", "une", "vos", "votre", "vous",
			"à", "y", "été", "étée", "étées", "étés", "étant", "suis", "es",
			"est", "sommes", "êtes", "sont", "serai", "seras", "sera",
	 ...
	 * Liste des mots vide de la langue française
	 */
	private static String french_list2[] = {"qu'", "c'", "d'", "j'", "l'", "m'", "n'", "s'", "t'"};

	public static List<String> chinese_StopWord = new ArrayList<String>(Arrays.asList(chinese_list));;
	public static List<String> english_StopWord = new ArrayList<String>(Arrays.asList(english_list));;
	public static List<String> french_StopWord = new ArrayList<String>(Arrays.asList(french_list));;
	public static List<String> french_StopWord2 = new ArrayList<String>(Arrays.asList(french_list2));;
}
